...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('Hello!', True, WHITE, DARKWHITE)
    titleSurf2 = titleFont.render('Retro Snaker!', True, GREEN)
...
def drawWorm(wormCoods):
    for coord in wormCoods:
        ...
        pygame.draw.rect(DISPLAYSURF, DARKWHITE, wormSegmentRect)
